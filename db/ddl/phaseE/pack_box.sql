...
-- Columns: box_line_id BIGINT UNSIGNED PK AUTO_INCREMENT, box_id FKâ†’pack_box_hdr, picking_line_id FKâ†’picking_line, packed_qty DECIMAL(12,2) NOT NULL CHECK (packed_qty >= 0), updated_by.
