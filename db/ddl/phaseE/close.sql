...
-- Columns: variance_id BIGINT UNSIGNED PK AUTO_INCREMENT, close_id FKâ†’close_hdr, ticket_line_id FKâ†’pick_ticket_line, requested_qty DECIMAL(12,2) NOT NULL, delivered_qty DECIMAL(12,2) NOT NULL, short_qty DECIMAL(12,2) NOT NULL, reason VARCHAR.
