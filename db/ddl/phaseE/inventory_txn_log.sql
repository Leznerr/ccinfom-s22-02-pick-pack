...
-- Columns (suggested): log_id BIGINT UNSIGNED PK AUTO_INCREMENT, product_id FKâ†’products, warehouse_id BIGINT NULL (future use), ticket_id BIGINT NULL, source_txn_type ENUM('RESERVE','CLOSE') NOT NULL, source_txn_id BIGINT NOT NULL, delta_reserved DECIMAL(12,2) NOT NULL, delta_on_hand DECIMAL(12,2) NOT NULL, note VARCHAR(300), created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, created_by VARCHAR(64) NOT NULL.
