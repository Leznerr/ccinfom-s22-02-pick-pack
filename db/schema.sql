-- ==========================================================
-- CCINFOM DEV â€” Phase B (Cores) + Phase C (T1 + T2)
...
-- ==========================================================
-- Phase B â€” CORES (no foreign keys in cores)
-- ==========================================================
...
-- Why: T3â€“T5 tables must be created in separate files to keep base schema clean and reusable across phases.
-- Steps:
