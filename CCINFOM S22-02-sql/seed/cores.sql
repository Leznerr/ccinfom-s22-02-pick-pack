...
('Villanueva','Ryan','driver','09178880003','ryan.villanueva@example.com','active','seed'),
('Ramos','Dionne','driver','09178880004','dionne.ramos@example.com','active','seed'),
('Navarro','Kurt','driver','09178880005','kurt.navarro@example.com','active','seed'),
('Sy','Allan','driver','09178880006','allan.sy@example.com','active','seed'),
('Uy','Patrick','driver','09178880007','patrick.uy@example.com','active','seed'),
('Carreon','Leo','driver','09178880008','leo.carreon@example.com','active','seed'),
('Domingo','Francis','driver','09178880009','francis.domingo@example.com','active','seed'),
('Ilagan','Rico','driver','09178880010','rico.ilagan@example.com','active','seed'),
('Velasco','Ivan','driver','09178880011','ivan.velasco@example.com','active','seed');
...
('Paranaque Satellite','19 Sucat Rd','Paranaque','Nina Dee','09190010009','active','seed'),
