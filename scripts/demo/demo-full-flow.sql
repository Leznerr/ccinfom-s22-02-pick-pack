-- Phase E full lifecycle demo scaffold (T1 â†’ T5)

-- TODO[E-DEMO-T5-001] Compose full happy path across T1â€“T5.
-- Outline:
...
-- Acceptance: Script runs without manual edits on clean DB; statuses progress Open â†’ Delivered.
